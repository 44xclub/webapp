...
export function ExerciseMatrix({ form }: ExerciseMatrixProps) {
  ...
  return (
    <div>
      ...
      <div className="bg-[var(--surface-1)] rounded-[var(--radius-card)] border border-[rgba(255,255,255,0.06)] p-2 pb-3">
        ...
        <div className="pt-3 flex items-center justify-center">
          <button
            type="button"
            onClick={addExercise}
            className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-[var(--radius-button)] border border-dashed border-[rgba(255,255,255,0.12)] text-[11px] font-medium text-[rgba(238,242,255,0.52)] hover:border-[rgba(255,255,255,0.24)] hover:text-[rgba(238,242,255,0.72)] hover:bg-[rgba(255,255,255,0.02)] transition-all"
          >
    ...
    <div className="bg-[var(--surface-2)] rounded-[var(--radius-button)] border border-[rgba(255,255,255,0.08)] overflow-hidden shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_1px_3px_rgba(0,0,0,0.2)]">
      ...
      <div className="flex items-center gap-1.5 px-2 py-1.5">
        ...
        <input
          ...
          className="flex-1 bg-transparent text-[11px] font-semibold text-[#eef2ff] placeholder:text-[rgba(238,242,255,0.30)] outline-none"
        />
        <span className="text-[9px] text-[rgba(238,242,255,0.40)] tabular-nums">
      ...
      {expanded && (
        <div className="border-t border-[rgba(255,255,255,0.06)]">
          {/* Table Header */}
          <div className="grid grid-cols-[26px_1fr_1fr_24px] gap-1 px-2 py-1 bg-[rgba(0,0,0,0.15)]">
            <span className="text-[8px] font-semibold uppercase tracking-wider text-[rgba(238,242,255,0.35)]">Set</span>
            <span className="text-[8px] font-semibold uppercase tracking-wider text-[rgba(238,242,255,0.35)]">Reps</span>
            <span className="text-[8px] font-semibold uppercase tracking-wider text-[rgba(238,242,255,0.35)]">Weight</span>
            <span></span>
          </div>
          ...
          {sets.map((setField, setIndex) => (
            <div
              key={setField.id}
              className="grid grid-cols-[26px_1fr_1fr_24px] gap-1 px-2 h-[32px] items-center border-t border-[rgba(255,255,255,0.04)]"
            >
              <span className="text-[10px] font-medium text-[rgba(238,242,255,0.52)] tabular-nums text-center">
                {setIndex + 1}
              </span>
              <input
                ...
                placeholder="—"
                inputMode="numeric"
                className="w-full bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.06)] rounded-[5px] px-1.5 py-0.5 text-[11px] text-[#eef2ff] placeholder:text-[rgba(238,242,255,0.25)] outline-none focus:border-[rgba(59,130,246,0.5)] focus:bg-[rgba(255,255,255,0.08)] transition-all tabular-nums"
              />
              <input
          ...
          {/* Add Set + Notes */}
          <div className="px-2 py-1.5 flex items-center justify-between border-t border-[rgba(255,255,255,0.06)]">
            <button
              type="button"
              onClick={addSet}
              className="flex items-center gap-1 px-2 py-1 rounded-[6px] text-[10px] font-medium text-[rgba(238,242,255,0.52)] hover:text-[#3b82f6] hover:bg-[rgba(59,130,246,0.08)] transition-all"
            >
            ...
            <input
              ...
              placeholder="Notes..."
              className="text-right bg-transparent text-[10px] text-[rgba(238,242,255,0.52)] placeholder:text-[rgba(238,242,255,0.25)] outline-none w-[120px] hover:text-[rgba(238,242,255,0.72)] transition-colors"
            />
          </div>
        </div>
      )}
